...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım örnek: **${ayar.bot.botPrefix}git @Noâ/ID**`)).sil(7);
...
exports.config = {
    name: "git",
    usage: `${ayar.bot.botPrefix}git [@Noâ/ID]`,
    guildOnly: true,
    aliases: [],
    cooldown: 3000
};