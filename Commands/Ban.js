...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member || !sebep) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}ban @Noâ/ID [Reason]**`)).sil(7)
...
exports.config = {
    name: "ban",
    usage: `${ayar.bot.botPrefix}ban [@Noâ/ID] [reason]`,
    guildOnly: true,
    aliases: [],
    cooldown: 3000
};