...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}unvmute @Noâ/ID**`)).sil(7)
...
exports.config = {
    name: "unvmute",
    usage: `${ayar.bot.botPrefix}unvmute [@Noâ/ID]`,
    guildOnly: true,
