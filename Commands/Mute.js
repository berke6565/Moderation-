...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member || !zaman || !sebep) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}mute @Noâ/ID [Time] [Reason]**`)).sil(7)
...
exports.config = {
    name: "mute",
    usage: `${ayar.bot.botPrefix}mute [@Noâ/ID] [Time] [Reason]`,
    guildOnly: true,
