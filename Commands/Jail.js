...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member || !sebep) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}jail @Noâ/ID [Reason]**`)).sil(7)
...
exports.config = {
    name: "jail",
    usage: `${ayar.bot.botPrefix}jail [@Noâ/ID] [Reason]`,
    guildOnly: true,
