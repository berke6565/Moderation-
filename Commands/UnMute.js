...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}unmute @Noâ/ID**`)).sil(7)
...
exports.config = {
    name: "unmute",
    usage: `${ayar.bot.botPrefix}unmute [@Noâ/ID]`,
    guildOnly: true,
