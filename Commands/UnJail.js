...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}unjail @Noâ/ID**`)).sil(7)
...
exports.config = {
    name: "unjail",
    usage: `${ayar.bot.botPrefix}unjail [@Noâ/ID]`,
    guildOnly: true,
    aliases: ["unjailmute"],
    cooldown: 3000
};