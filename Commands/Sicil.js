...
module.exports.run = async(client, message, args, embed) => {
    ...
    if (!member) return message.channel.send(embed.setDescription(`${message.member}, Hatalı kullanım. Örnek: **${ayar.bot.botPrefix}sicil @Noâ/ID**`)).sil(7)
...
exports.config = {
    name: "sicil",
    usage: `${ayar.bot.botPrefix}sicil [@Noâ/ID]`,
    guildOnly: true,
    aliases: [],
    cooldown: 3000
};